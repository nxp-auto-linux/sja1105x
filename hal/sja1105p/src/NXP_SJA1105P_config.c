...
#define APPBOARD_PORT_MAPPING {{0, 0}, {1, 0}, {2, 0}, {3, 0}, {4, 0}} /**< Mapping between logical ports used in the driver API and the physical ports on the ICs. Syntax: {{physical port of port 0, physical switch of port 0}, ...} */
